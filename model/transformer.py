"""
    Implementation of Dual Attention
"""
...
class Transformer(nn.Module):
    def __init__(self, d_model=25, nhead=5, num_encoder_layers=6,
...
class TransformerEncoderLayer(nn.Module):
    def __init__(self, d_model=768, nhead=5, dim_feedforward=2048, dropout=0.1,
                 activation="relu", normalize_before=False):
        super().__init__()
